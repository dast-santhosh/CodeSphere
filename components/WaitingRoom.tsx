    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      <header className="h-16 border-b border-slate-800 bg-slate-900 flex items-center justify-between px-6">
         <div className="flex items-center">
            <div className="w-10 h-10 rounded-full overflow-hidden shadow-lg shadow-primary-500/20 mr-3 border border-primary-500/30">
         ...
         <button 
            onClick={onLogout}
            className="text-slate-400 hover:text-white flex items-center text-sm font-medium"
         >
      ...
      <div className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto p-8">
              {/* Status Banner */}
              <div className="bg-slate-900 border border-yellow-500/20 rounded-2xl p-8 text-center mb-10 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-yellow-500 to-transparent opacity-50"></div>
                  <div className="w-16 h-16 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto mb-4 text-yellow-500 animate-pulse">
                      <Clock size={32} />
                  </div>
